...
class CustomCursor {
  ...
  _bindEvents() {
    ...
    document.addEventListener('mouseover', (e) => {
      ...
      const noteSticker = e.target.closest('.image-sticker--note, .draggable-sticker--note');
    ...
    document.addEventListener('mouseout', (e) => {
      const card = e.target.closest('.work-card, .info-card, .game-card, .work-stack, .image-sticker--note, .draggable-sticker, #sticker-naruto');
      if (card) {
